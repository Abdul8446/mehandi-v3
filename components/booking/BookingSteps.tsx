...
//               <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= step ? 'bg-red-900 text-white' : 'bg-gray-200 text-gray-600'}`}>
//                 {step}
//               </div>
//               <div className={`ml-2 ${currentStep >= step ? 'text-gray-900 font-medium' : 'text-gray-500'}`}>
//                 {step === 1 && 'Select Plan'}
//                 {step === 2 && 'Date & Time'}
//                 {step === 3 && 'Details'}
//                 {step === 4 && 'Confirmation'}
...
//             </div>
//             {step < 4 && (
//               <div className={`flex-1 mx-4 h-1 ${currentStep > step ? 'bg-red-900' : 'bg-gray-200'}`}></div>
//             )}
//           </React.Fragment>
//         ))}
//       </div>
